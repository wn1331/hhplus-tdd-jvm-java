...
<p>무한 대기 상태: 한 스레드가 syncronized 블록을 장기간 점유하게 되면 다른 스레드들이 영원히 대기할 수 있다. 교착상태(데드락)과 개념은 비슷하지만 엄연히 다르다. </p>
<p>교착상태: 두개 이상의 스레드가 서로 다른 자원을 점유한 채 다른 스레드의 자원을 얻으려고 무한히 대기하는 상태이다.</p>
<p>공정성 문제 : syncronized는 스레드가 락을 획득하는 순서를 보장하지 않는다. </p>

<h3>LockSupport</h3>
syncronized의 단점을 보완하기 위해 나타난 녀석.
...
<h3>ReentrantLock</h3>
자바 5부터 도입된 고급 락 매커니즘으로 syncronized의 단점을 보완하기 위해 나타난 녀석.
